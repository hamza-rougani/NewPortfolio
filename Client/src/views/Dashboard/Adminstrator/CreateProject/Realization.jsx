...
function Realization(e) {
  ...
  <div key={index} className='post'>
    <h3>{o}</h3>
    <div className='generaleI'><div className='image'><img src={infoEdit.images[index] ?typeof(infoEdit.images[index])=="string" ? `${import.meta.env.VITE_API2_BASE_URL}/${infoEdit.images[index]}` : URL.createObjectURL(infoEdit.images[index]):"https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABlN930GwaMQz.jpg"} alt="" /></div></div>
